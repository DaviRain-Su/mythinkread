...
export default function BooksPage() {
  ...
  return (
    <div style={{ maxWidth: '72rem', margin: '0 auto', padding: '2rem 1rem' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1.5rem' }}>书库</h1>
          ...
          >
            ...
            <div style={{ marginTop: '0.5rem' }}>
              <span style={{
                ...
                backgroundColor: book.ai_mode === 'ai_only' ? '#fef3c7' : '#dbeafe',
                color: book.ai_mode === 'ai_only' ? '#92400e' : '#1e40af',
